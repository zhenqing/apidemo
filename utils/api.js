...
module.exports = {
    fetchAccountLogs: function(account, country, account_name, business, belonging) {
        var encodeURI = window.encodeURI('https://a9test.ibport.com/api/v1/account_logs?country=' + country + '&account=' + account + '&account_name=' + account_name + '&business=' + business+ '&log_date=2018-02-09' + '&belonging=' + belonging +'&access_token=b41127cf658eeb348ebc5a9513826bb0')
    ...
    fetchFunds: function(account, country, account_name, business, belonging) {
        var encodeURI = window.encodeURI('https://a9test.ibport.com/api/v1/account_logs/fund?country=' + country + '&account_name=' + account + '&business=' + business+ '&log_date=2018-02-09' + '&belonging=' + belonging +'&access_token=b41127cf658eeb348ebc5a9513826bb0')
        return axios.get(encodeURI)
            .then(function (response) {
                return response.data;
            });
    ...
    fetchFundsTmr: function(account, country, account_name, business, belonging) {
        var encodeURI = window.encodeURI('https://a9test.ibport.com/api/v1/account_logs/fund?country=' + country + '&account_name=' + account + '&business=' + business+ '&log_date=2018-02-09' + '&belonging=' + belonging +'&option=tomorrow&access_token=b41127cf658eeb348ebc5a9513826bb0')
        return axios.get(encodeURI)
            .then(function (response) {
                return response.data;
            });
    ...
    fetchFundsWeek: function(account, country, account_name, business, belonging) {
        var encodeURI = window.encodeURI('https://a9test.ibport.com/api/v1/account_logs/fund?country=' + country + '&account_name=' + account + '&business=' + business+ '&log_date=2018-02-09' + '&belonging=' + belonging +'&option=nextweek&access_token=b41127cf658eeb348ebc5a9513826bb0')
        return axios.get(encodeURI)
            .then(function (response) {
                return response.data;
            });
